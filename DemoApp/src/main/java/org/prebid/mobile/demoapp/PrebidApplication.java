...
public class PrebidApplication extends Application {
    ...
    private void initialisePrebidForDFP() {
        ...
        //A- Setup and create ad units
        ArrayList<AdUnit> adUnits = new ArrayList<AdUnit>();

        //Configure Ad-Slot1
        BannerAdUnit adUnit1 = new BannerAdUnit(BANNER_320x50, PBS_CONFIG_RUBICON_DEMAND);
        adUnit1.addSize(320, 50);

        //Configure Ad-Slot2 with the same demand source
        BannerAdUnit adUnit2 = new BannerAdUnit(BANNER_300x250, PBS_CONFIG_300x250_RUBICON_DEMAND);
        adUnit2.addSize(300, 250);
        adUnit2.addSize(300, 600);

        //Configure Interstitial Ad Unit
        InterstitialAdUnit adUnit3 = new InterstitialAdUnit(INTERSTITIAL_FULLSCREEN, PBS_CONFIG_RUBICON_DEMAND);
