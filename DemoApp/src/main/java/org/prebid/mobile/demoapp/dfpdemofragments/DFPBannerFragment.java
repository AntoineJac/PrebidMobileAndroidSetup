...
//        setupBannerWithWait(500);
        ...
        adListener = new AdListener() {
            ...
            public void onAdClosed() {
                super.onAdClosed();
                Log.d("DPF-Banner", "OnAdClosed");
            }

            @Override
            public void onAdFailedToLoad(int i) {
                super.onAdFailedToLoad(i);
                Log.d("DPF-Banner", "OnAdFailedToLoad");
            }

            @Override
            public void onAdLeftApplication() {
                super.onAdLeftApplication();
                Log.d("DPF-Banner", "onAdLeftApplication");
            }

            @Override
            public void onAdOpened() {
                super.onAdOpened();
                Log.d("DPF-Banner", "onAdOpened");
            }

            @Override
            public void onAdLoaded() {
                super.onAdLoaded();
                Log.d("DPF-Banner", "onAdLoaded");
            }
        };
